...
//
// Run: ./build_unified/hellcat_unified_tests hellcat_fx_modrate_test
...
static void testAudioRateModulation()
{
    ...
    auto setLfoRate = [] (HellcatAudioProcessor& p, int rate)
    {
    ...
    auto renderPeak = [] (HellcatAudioProcessor& p, int blocks) -> double
    {
