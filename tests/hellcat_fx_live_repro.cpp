...
TEST(hellcat_fx_live_repro)
{
    ...
    // Pin the card: the chord-health floor was calibrated under the Ladder
    // card (this scenario targets FX dropout health, not the filter card).
