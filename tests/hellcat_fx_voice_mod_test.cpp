...
//
// Run: ./build_unified/hellcat_unified_tests hellcat_fx_voice_mod_test
...
void routeParam1 (HellcatAudioProcessor& proc, int source, uint8_t baseParam1)
{
...
float meanEffParam (HellcatAudioProcessor& proc, int block, int blocks)
{
...
TEST(hellcat_fx_voice_mod_test)
{
