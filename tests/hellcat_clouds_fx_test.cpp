...
//
// Run: ./build_unified/hellcat_unified_tests hellcat_clouds_fx_test
...
TEST(hellcat_clouds_fx_test)
{
    ...
    // chunk (Hellcat FX slots have no background thread).
    {
    ...
    // render a FINITE, non-silent, dry-differing block through the real Hellcat
