...
// the real HellcatAudioProcessor::processBlock from a FRESH plugin state
...
// hellcat_clouds_fx_test (rails-bounded + continuous under deep overrun,
// also validated to fail catastrophically on d2669c4).
//
// Build: part of the hellcat_unified_tests binary (unified_test_runner harness).
...
//     oversampling) is pinned separately by hellcat_fv1_alias_probe numbers
//     in the changelog.
...
TEST(hellcat_fx_onset_regression)
{
