// Phase-3 verification harness for the Hellcat (Ambika) port.
//
...
// toolchain (hellcat_multi_load_test already builds clean for the iOS
...
// ---------------------------------------------------------------------------
    ...
    #define HELLCAT_TESTS_IOS 1
#endif

bool toolAvailable (const char* name)
{
#ifdef HELLCAT_TESTS_IOS
...
TEST(hellcat_tests)
{
    std::printf ("=== Hellcat Phase-3 verification ===\n");
