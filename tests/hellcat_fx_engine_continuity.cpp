...
// HellcatAudioProcessor::processBlock (-> renderPartFx -> FxChain -> each Clouds
...
//
// Build: linked as hellcat_fx_engine_continuity_test (see CMakeLists).
...
TEST(hellcat_fx_engine_continuity)
{
