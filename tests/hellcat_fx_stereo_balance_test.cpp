...
//
// Run: ./build_unified/hellcat_unified_tests hellcat_fx_stereo_balance_test
...
TEST(hellcat_fx_stereo_balance_test)
{
    ...
    std::printf ("=== Hellcat FX stereo-balance investigation ===\n");
