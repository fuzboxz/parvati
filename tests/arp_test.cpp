...
int main()
{
    ...
    std::printf ("[arp_test] descriptor count: %d (expected 259 = 105 + 5 arp + 4 options + 67 sequencer + 78 fx)\n", descCount);
    check (descCount == 259, "descriptor table includes 5 arp params (+4 options + 67 sequencer + 78 fx)");
