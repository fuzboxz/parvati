...
int main()
{
    ...
    std::printf ("[arp_test] descriptor count: %d (expected 257 = 105 + 5 arp + 4 options + 67 sequencer + 76 fx)\n", descCount);
    check (descCount == 257, "descriptor table includes 5 arp params (+4 options + 67 sequencer + 76 fx)");
