...
Covered: Wavefolder LUT-domain crash regression + continuity (`hellcat_clouds_fx_test.cpp:897-990`); latency()==8 and topology accumulations (`fx_param_coverage_test.cpp:515-611`); D1/D2 blend alignment (`fx_routing_test.cpp:280-321`); OS sub-block survival 1..512 (`hellcat_fx_modrate_test.cpp:118-165`); FV-1 framework round-trip, BW stability, delay/fixed-point units (`fv1_engine_test.cpp`); tail table (`render_quality_test.cpp:351-459`).
