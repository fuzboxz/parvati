...
// parameter.
//
// The patch surface exposed by getPatchParamDescriptors() is 183 parameters:
//   119 concrete "curated" entries (oscillators, mixer, filters, the 3
...
//
// getParamHelp() returns non-empty for all 183 paramIDs; it returns an empty
...
// Curated paramID -> description map (the 119 non-seq-step entries).
